<?php include '../GalleryCafeWeb/includes/header.php'; ?>
  ...
  <main>
    <article>
      ...
      <section class="hero" id="home" style="background-image: url('./assets/images/background2.jpg')">
        <div class="container">

          <div class="hero-content">

            <p class="hero-subtitle">Try Delicious Food</p>

            <h2 class="h1 hero-title">Savor  the Flavor</h2>
      ...
      <section class="hero" id="about" style="background-color:#060606;"><br>
        <div class="container">
         <div class="hero-content">
        <br>
        <h2 class="h1 hero-title"   style="margin-left: 1px;">Why The Gallery Cafe?</h2>
        <br>
        <div class="about-wrapper">
          <div style="text-align: left;">
        <p class="section-text">Gallery Café is more than just a place to grab coffee. 
           It's where creativity meets community. Our walls showcase local artists,
           and our menu celebrates flavors from around the world.At Galler Cafe, 
           we pride ourselves on offering a unique blend of exceptional coffee, 
           delightful pastries, and a cozy atmosphere that feels like home. 
           Our team is passionate about creating a welcoming space where you can relax, 
           work, or catch up with friends. We believe in quality, community, and the art of coffee.</p>
           </div>
           </div>
           <div>
        <img src="./assets/images/about-banner.png" style="margin-left: 600px;">
           </div>
        </div>
        </div>
    </section>
     ...
     <!-- 
      ...
      <section class="section section-divider white promo" style="background-color:#060606";><br><br>
        <div class="container">
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title" style="color: aliceblue";>Meals</h3>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title" style="color: aliceblue;">Soft Drinks</h3>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title" style="color: aliceblue";>Desserts</h3>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title" style="color: aliceblue";>Bakery Items</h3>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title"style="color: aliceblue";>Coffees</h3>
      ...
      <section class="section section-divider white cta" style="background-color:#060606";>
        <div class="container">
      ...
      <section class="section event bg-black-10" style="background-color: #060606;">
        <div class="container">

          <p class="hero-subtitle" style="text-align: center;">Recent Updates</p>

          <h2 class="h1 hero-title" style="text-align: center;">Upcoming Event</h2><br>
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  ...
                  <time class="publish-date label-2" datetime="2024-07-17">17/07/2024</time>
                </div>
        ...
        <div class="container">
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <h2 class="hero-title text-center">Online Reservation</h2>
